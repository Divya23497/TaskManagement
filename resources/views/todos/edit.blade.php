        ...
        <div class="container-fluid  dashboard-content">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Update Tasks</h5>
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('tasks.update', $task->id) }}" method="post"
                                enctype="multipart/form-data" id="update_tasks">
                                @csrf
                                @method('PATCH')
                                <div class="form-row">
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <input type="text" class="form-control" name="task_title" id="task_title"
                                            value="{{ $task->task_name }}" placeholder="Task Title" />
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <select class="form-control" name="priority" required>
                                            ...
                                            <option value="high"
                                                {{ ($task->task_type ?? '') == 'high' ? 'selected' : '' }}>High</option>
                                            <option value="medium"
                                                {{ ($task->task_type ?? '') == 'medium' ? 'selected' : '' }}>Medium</option>
                                            <option value="low"
                                                {{ ($task->task_type ?? '') == 'low' ? 'selected' : '' }}>Low</option>
                                            </option>
                                        ...
                                        <select class="form-control" name="assign_name" id="assign_name" required>
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}"
                                                    {{ old('user', $task->assigned_to ?? '') == $user->id ? 'selected' : '' }}>
                                                    {{ ucfirst($user->name) }}
                                                </option>
                                            @endforeach
                                            </option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <select class="form-control" name="status" required>
                                            ...
                                            <option value="Not Started"
                                                {{ ($task->task_status ?? '') == 'Not Started' ? 'selected' : '' }}>Not
                                                Started</option>
                                            <option value="In Progress"
                                                {{ ($task->task_status ?? '') == 'In Progress' ? 'selected' : '' }}>In
                                                Progress</option>
                                            <option value="Completed"
                                                {{ ($task->task_status ?? '') == 'Completed' ? 'selected' : '' }}>Completed
                                            </option>
                                            <option value="Cancelled"
                                                {{ ($task->task_status ?? '') == 'Cancelled' ? 'selected' : '' }}>Cancelled
                                            </option>
                                            <option value="On Hold"
                                                {{ ($task->task_status ?? '') == 'On Hold' ? 'selected' : '' }}>On Hold
                                            </option>
                                             <option value="Rework"
                                                {{ ($task->task_status ?? '') == 'Rework' ? 'selected' : '' }}>Rework
                                            </option>
                                            <option value="Review"
                                                {{ ($task->task_status ?? '') == 'Review' ? 'selected' : '' }}>Review
                                            </option>
                                            </option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <textarea name="desc" id="desc" row="5" class="form-control mb-1" placeholder="">{{ $task->task_desc }}</textarea>
                                        <div class="valid-feedback"></div>
                                    </div>

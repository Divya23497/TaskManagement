            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        ...
                        <h5 class="card-header">Time Tracking vs Estimated</h5>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                         @foreach ($alltasks as $key => $task)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $task->actual ?? '-' }}</td>
                                                <td class="{{ $task->variance > 0 ? 'text-danger' : ($task->variance < 0 ? 'text-success' : '') }}">
                                                    {{ $task->variance !== null ? ($task->variance > 0 ? '+' : '') . $task->variance : '-' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
